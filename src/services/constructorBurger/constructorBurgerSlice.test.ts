...
import type { constructorState } from './constructorBurgerSlice';
...
describe('constructorBurgerSlice. Экшен тест конструктора', () => {
  ...
  test('constructorBurgerSlice. Экшен тест для добавления ингредиента', () => {
    const ingredient = {
  ...
  test('constructorBurgerSlice. Экшен тест для экшена удаления ингредиента', () => {
  ...
  describe('constructorBurgerSlice. Экшен тест для изменения порядка ингредиентов', () => {
    test('constructorBurgerSlice. Экшен тест для перемещения ингредиента вниз', () => {
    ...
    test('constructorBurgerSlice. Экшен тест для перемещения ингредиента вверх', () => {
      const ingredientId = 1;
      const endState: constructorState = JSON.parse(JSON.stringify(startState));
      [
        endState.constructorItems.ingredients[ingredientId],
